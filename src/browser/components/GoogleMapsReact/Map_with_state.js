...
export class Map extends React.Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    console.log('did update this.props', this.props, prevProps);
    if (prevProps.google !== this.props.google) {
      console.log('%c google change, load Map', 'color:green;font-weight:bold');
      this.loadMap();
    }
    if (this.props.mapType !== prevProps.mapType) {
      console.log('%c mapType change, load Map', 'color:green;font-weight:bold');
      this.loadMap();
    }
    if (this.props.visible !== prevProps.visible) {
      console.log('%c restyle Map', 'color:green;font-weight:bold');
      this.restyleMap();
    }
    if (this.map && this.props.zoom !== prevProps.zoom) {
      console.log('%c zoom Map', 'color:green;font-weight:bold');
      this.map.setZoom(this.props.zoom);
    }
    if (this.props.center !== prevProps.center) {
      console.log('%c new location Map', 'color:green;font-weight:bold');
      this.setState({
        currentLocation: this.props.center,
      });
    }
    if (prevState.currentLocation !== this.state.currentLocation) {
      console.log('%c recenter Map', 'color:green;font-weight:bold');
      this.recenterMap();
    }
  }
  ...
  render() {
    ...
    console.log('+++++++render Google Map React++++++++++');
    return (
